...
plot3d(idskel, col = mycolors[[3]]) #choose the darkest colour in the gradient
points3d(dssyn, col = mycolors[[2]]) #choose the middle colour in the gradent
points3d(ussyn, add = T, col = mycolors[[1]]) #choose the lightest colour in the gradient
plot3d(elmr::FAFB)
