...
- select singleton/cell-type matches across 2 hemispheres of your choice;
    ...
    - get their l2 skeletons (maybe there’s hemibrain neuron skeletons somewhere already? For FAFB neurons, if you are coding in R, my current way is to copy the ids from R, go to python to get the l2 skeletons, download the skeletons, and then read them into R (Python code in thread));
