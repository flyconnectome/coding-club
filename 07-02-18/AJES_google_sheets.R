...
skids<- as.list(gs_read(ss = y5, ws = 4, range = "B52:B73"))[[1]] #misses first one in list
...
#Make a function that updates google sheet to add info about already connected neurons
